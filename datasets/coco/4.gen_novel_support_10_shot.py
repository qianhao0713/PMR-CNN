...
def main():
    dataDir = '/home/qianhao/ZSD_tcb/data/318/cattle_all_other_view'
    root_path = '/home/qianhao/PMR-CNN/datasets/coco'
    support_path = os.path.join(root_path, 'novel_20_shot_cattle_support')
    ...
    for dataType in ['train']:  # , 'train2017']:
        ...
        set_img_base_path = dataDir

        # other information
        # annFile = '{}/annotations/instances_{}.json'.format(dataDir,dataType)
        # annFile = './new_annotations/final_split_voc_10_shot_instances_train2017.json'

        # annFile = os.path.join(root_path, 'new_annotations/final_split_voc_10_shot_instances_train2017.json')
        annFile = os.path.join(root_path, 'new_annotations/instances_novel_20_shot.json')
        ...
        for img_id, id in enumerate(coco.imgs):
            ...
            # print(img['file_name'])
            frame_crop_base_path = join(set_crop_base_path, img['file_name'].split('/')[-1].split('.png')[0])
...
if __name__ == '__main__':
    since = time.time()
    support_df = main()
    support_df.to_pickle("./novel_20_shot_cattle_support_df.pkl")
